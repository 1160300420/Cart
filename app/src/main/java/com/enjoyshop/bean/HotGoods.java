...
public class HotGoods {
    ...
    public  HotGoods(String c,int t,int c2,int t2,int p,List<OrdersBean> o,List<ListBean> l){
        this.copyright=c;
        this.totalCount=t;
        this.currentPage=c2;
        this.totalPage=t2;
    ...
    public static class ListBean implements Serializable {
        ...
        private double sale;
        public ListBean(int i1,int cgd,int cpd,String na,String iul,double pr,double sa ){
            this.id=i1;
            this.categoryId=cgd;
            this.campaignId=cpd;
            this.name=na;
